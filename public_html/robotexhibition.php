...
<?php
	...
	include('db/dbh.php');
		...
		if($stmt = $conn->prepare("SELECT product_id, e_name, e_image, e_description, e_price, e_link FROM exhibitions WHERE e_name LIKE 'R%'")) {
			...
			while ($stmt->fetch()){
				...
				<div class='mySlides fade'>
  				...
  				<img src='images/robot-alex-knight.jpg' style='width:100%'>
				</div>
				<div class='mySlides fade'>
				<div class='numbertext'>2 / 3</div>
				<img src='images/robot-adam-muise.jpg' style='width:100%'>
				</div>
				<div class='mySlides fade'>
  				<div class='numbertext'>3 / 3</div>
  				<img src='images/robot-andy-kelly.jpg' style='width:100%'>
				</div>
				</div>
...
?>
	...
	<div class="main-sidebar">
		...
		<iframe src="https://www.facebook.com/plugins/share_button.php?href=https%3A%2F%2Ffacebook.com/roboticsengineering/%2Fdocs%2Fplugins%2F&layout=button&size=large&width=73&height=28&appId" width="73" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
